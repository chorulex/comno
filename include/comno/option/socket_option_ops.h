...
inline void getsockopt(const socket_t& sock_fd, OptionObj& opt, error_code& ec)
{
...
inline void setsockopt(const socket_t& sock_fd, const OptionProxy& opt, error_code& ec)
{
